...
int punch(Level* level){
	...
	if(level->current_board->board[targetX][targetY]){
		if(level->current_board->board[targetX][targetY]->type == 2){
			int is_alive = decrease_enemy(level->current_board->board[targetX][targetY]);
			if(is_alive){
				success = move_enemy(level->current_board->board,level->current_board->board[targetX][targetY],knight->direction);
			}else{
				success = 1;
			}
		}
...
int axe(Level* level){
	...
	if(knight->direction == 'l'){
		for (int i = 2; i > 0; i--){
			if(level->current_board->board[knight->x][knight->y-i]){
				if(level->current_board->board[knight->x][knight->y-i]->type == 2){
					int is_alive = decrease_enemy(level->current_board->board[knight->x][knight->y-i]);
					if(is_alive){
						success = move_enemy(level->current_board->board,level->current_board->board[knight->x][knight->y-i],knight->direction);
					}else{
						success = 1;
					}
				}
		...
		for (int i = 2; i > 0; i--){
			if(level->current_board->board[knight->x-i][knight->y]){
				if(level->current_board->board[knight->x-i][knight->y]->type == 2){
					int is_alive = decrease_enemy(level->current_board->board[knight->x-i][knight->y]);
					if(is_alive){
						success = move_enemy(level->current_board->board,level->current_board->board[knight->x-i][knight->y],knight->direction);
					}else{
						success = 1;
					}
				}
